...
class Template
{
    private $viewPath = '%s/src/App/Views';
    private $baseView = 'base.html';
    private $reservedVariables = ['application_name', 'body'];
 
    public function __construct()
    {
        $this->viewPath = sprintf($this->viewPath, $_ENV['APP_ROOT']);
    }
    ...
    private function validateVariables(array $variables = [])
    {
        ...
        $variables['application_name'] = $_ENV['APP_NAME'];
    ...
    {
        return str_replace($_ENV['APP_CONTROLLER_METHOD_SUFFIX'], null, $controller);
    }
}